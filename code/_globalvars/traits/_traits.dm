...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/obj/item/toy/plush/nova = list(
		...
		"TRAIT_ROBOTIC_LIMBATTACHMENT" = TRAIT_ROBOTIC_LIMBATTACHMENT,
		...
		"TRAIT_EXTRACT_TO_FILTRE_SHIP" = TRAIT_EXTRACT_TO_FILTRE_SHIP,
		"TRAIT_INFIL_BUFF" = TRAIT_INFIL_BUFF,
		"TRAIT_NO_EXTRACT" = TRAIT_NO_EXTRACT,
		"TRAIT_EXTRACT_TO_NINJA_HIDEOUT" = TRAIT_EXTRACT_TO_NINJA_HIDEOUT,
	),
